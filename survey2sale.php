    			...
    			<script type="text/javascript">
					...
					jQuery( document ).ready(function() {
					    jQuery("#s2s_btn").click(function() {
					    	var tmp_enable = jQuery("#s2s_enable").val();
					    	if(tmp_enable == "true") {
					    		jQuery("#s2s_enable").val("false");
					    	}
					    	else {
					    		jQuery("#s2s_enable").val("true");
					    	}
    			...
    			<div class="s2s_enable_container">
    				<div class="s2s_enable_btn">
        				<input type="hidden" name="s2s_options[s2s_enable]" id="s2s_enable" value="<?php echo $options['s2s_enable']; ?>"  />
            				The Survey-2-Sale plugin is currently 
            				<?php 
            					if($options['s2s_enable'] == "true") {
            				?>		<span style="color:green; font-style:italic;">enabled</span><br />
            				...
            				?>		<span style="color:red; font-weight:bold;">DISABLED</span><br /><div class="button-primary s2s_submit_btn" id="s2s_btn">
